...
__dppl_give const char* DPPLDevice_GetName(
    __dppl_keep const DPPLSyclDeviceRef DRef) {
...
__dppl_give const char* DPPLDevice_GetVendorName(
    __dppl_keep const DPPLSyclDeviceRef DRef) {
...
__dppl_give const char* DPPLDevice_GetDriverInfo(
    __dppl_keep const DPPLSyclDeviceRef DRef) {
