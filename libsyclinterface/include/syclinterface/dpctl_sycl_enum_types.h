...
typedef enum
{
    ...
    DPCTL_PARTITION_BY_AFFINITY_DOMAIN
...
typedef enum
{
    ...
    DPCTL_FP_ROUND_TO_ZERO,
    DPCTL_FP_ROUND_TO_INF,
    DPCTL_FP_FMA,
    DPCTL_FP_CORRECTLY_ROUNDED_DIVIDE_SQRT,
    DPCTL_FP_SOFT_FLOAT
} DPCTLFPConfigType;
...
typedef enum
{
    ...
    DPCTL_MEMORY_ORDER_ACQ_REL,
    DPCTL_MEMORY_ORDER_SEQ_CST
...
typedef enum
{
    ...
    DPCTL_MEMORY_SCOPE_DEVICE,
    DPCTL_MEMORY_SCOPE_SYSTEM
